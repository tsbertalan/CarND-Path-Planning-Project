    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
            ...
            // Get a pair of reference points in global coordinates,
            // and add them to the list to which we'll fit a spline.
            if(prev_size < 2) {
                // If previous path is mostly empty, just use car state.
                ref_x = car_x;
                ref_y = car_y;
            ...
            // Change reference frame from global to car.
            ...
            // Define the actual (x,y) points we will use for the planner (in global coordinates).
            ...
            // Linearize the spline at a horizon target_x away from the car.
            // N * 0.02 * vel == target_x
            ...
            for(int i=1; i<= 50 - previous_path_x.size(); i++) {
                ...
                // Rotate back to normmal after rotating to car frame earlier.
